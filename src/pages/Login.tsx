        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="glass-card rounded-2xl p-8 animate-scale-in">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-12 h-12 bg-secondary border-0 text-foreground placeholder:text-muted-foreground rounded-xl"
                            />
                        </div>
                    ...
                    <div className="mt-6">
                        <p className="text-center text-muted-foreground text-sm mb-4">or login with:</p>
                        <div className="flex justify-center gap-4">
                            <button className="h-12 px-8 rounded-full bg-white flex items-center justify-center hover:bg-gray-100 transition-colors">
